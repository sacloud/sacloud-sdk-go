...
var operationRolesBasicAuth = map[string][]string{
	CreateVaultOperation:       []string{},
	CreateVaultSecretOperation: []string{},
	DeleteVaultOperation:       []string{},
	DeleteVaultSecretOperation: []string{},
	ListVaultSecretsOperation:  []string{},
	ListVaultsOperation:        []string{},
	ReadVaultOperation:         []string{},
	UnveilSecretOperation:      []string{},
	UpdateVaultOperation:       []string{},
}

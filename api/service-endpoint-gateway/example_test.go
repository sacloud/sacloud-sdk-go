				...
				ServiceEndpointGateway: v1.ModelsSettingsServiceEndpointGatewaySettings{
					...
					DNSForwarding: v1.OptModelsSettingsDNSForwardingSettings{
						Value: v1.ModelsSettingsDNSForwardingSettings{
							...
							PrivateHostedZone: v1.NewOptString("your-private-hosted-zone"), // "example.com" etc...
							UpstreamDNS1:      v1.NewOptString("your-upstream-dns-1"),      // "ns1.example.com" etc...
							UpstreamDNS2:      v1.NewOptString("your-upstream-dns-2"),      // "ns2.example.com" etc...
						},
						Set: true,
					},
				},

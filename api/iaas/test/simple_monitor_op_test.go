...
var (
	...
	createSimpleMonitorExpected = &iaas.SimpleMonitor{
	...
	updateSimpleMonitorParam = &iaas.SimpleMonitorUpdateRequest{
	...
	updateSimpleMonitorExpected = &iaas.SimpleMonitor{
		Name:               createSimpleMonitorParam.Target,
	...
	updateSimpleMonitorSettingsParam = &iaas.SimpleMonitorUpdateSettingsRequest{
		MaxCheckAttempts: 10,
		RetryInterval:    100,
		DelayLoop:        120,
		HealthCheck: &iaas.SimpleMonitorHealthCheck{
	...
	updateSimpleMonitorSettingsExpected = &iaas.SimpleMonitor{
		Name:               createSimpleMonitorParam.Target,
		Description:        updateSimpleMonitorParam.Description,
		Tags:               updateSimpleMonitorParam.Tags,
		Target:             createSimpleMonitorParam.Target,
	...
	updateSimpleMonitorToMinExpected = &iaas.SimpleMonitor{
		Name:               createSimpleMonitorParam.Target,
		Target:             createSimpleMonitorParam.Target,
...
func testSimpleMonitorDelete(ctx *testutil.CRUDTestContext, caller iaas.APICaller) error {
	client := iaas.NewSimpleMonitorOp(caller)
	return client.Delete(ctx, ctx.ID)
}

func TestSimpleMonitorOp_StatusAndHealth(t *testing.T) {
	client := iaas.NewSimpleMonitorOp(singletonAPICaller())
	testutil.RunCRUD(t, &testutil.CRUDTestCase{
		Parallel: true,

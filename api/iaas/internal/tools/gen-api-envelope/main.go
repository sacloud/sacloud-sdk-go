...
import (
{{- range .ImportStatements "github.com/sacloud/sacloud-sdk-go/api/iaas/types" "github.com/sacloud/sacloud-sdk-go/api/iaas/naked" "github.com/sacloud/sacloud-sdk-go/api/iaas/search" }}
	{{ . }}
{{- end }}
)

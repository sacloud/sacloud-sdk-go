...
import (
{{- range .ImportStatements "sync" "github.com/sacloud/sacloud-sdk-go/api/iaas" "github.com/sacloud/sacloud-sdk-go/api/iaas/types"}}
	{{ . }}
{{- end }}
)
...
import (
{{- range .ImportStatements "context" "github.com/sacloud/sacloud-sdk-go/api/iaas" "github.com/sacloud/sacloud-sdk-go/api/iaas/types"}}
	{{ . }}
{{- end }}
)
...
import (
{{- range .ImportStatements "testing" "github.com/sacloud/sacloud-sdk-go/api/iaas" "github.com/sacloud/sacloud-sdk-go/api/iaas/types"}}
        {{ . }}
{{- end }}
)

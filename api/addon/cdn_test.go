...
func setupCDN(t *testing.T, v encodable, s ...int) (*require.Assertions, CDNAPI) {
...
func TestNewCDNOp(t *testing.T) {
	assert, api := setupCDN(t, nil, http.StatusAccepted)
	assert.NotNil(api)
}

func TestCDNOp_List_200(t *testing.T) {
	assert, api := setupCDN(t, &MockListResourcesResponse)
...
func TestCDNOp_List_400(t *testing.T) {
	assert, api := setupCDN(t, &MockErrorResponse, http.StatusBadRequest)
...
func TestCDNOp_List_404(t *testing.T) {
	assert, api := setupCDN(t, nil, http.StatusNotFound)
...
func TestCDNOp_Create_202(t *testing.T) {
	assert, api := setupCDN(t, &MockPostDeploymentResponse, http.StatusAccepted)

	result, err := api.Create(t.Context(), CDNCreateParams{
		Location:     "japaneast",
...
func TestCDNOp_Create_400(t *testing.T) {
	assert, api := setupCDN(t, &MockErrorResponse, http.StatusBadRequest)
...
func TestCDNOp_Read_200(t *testing.T) {
	assert, api := setupCDN(t, &MockResourceResponse)
...
func TestCDNOp_Read_400(t *testing.T) {
	assert, api := setupCDN(t, &MockErrorResponse, http.StatusBadRequest)
...
func TestCDNOp_Read_404(t *testing.T) {
	assert, api := setupCDN(t, nil, http.StatusNotFound)
...
func TestCDNOp_Delete_204(t *testing.T) {
	assert, api := setupCDN(t, nil, http.StatusNoContent)

	err := api.Delete(t.Context(), "test-rg")
	assert.NoError(err)
}

func TestCDNOp_Delete_400(t *testing.T) {
	assert, api := setupCDN(t, &MockErrorResponse, http.StatusBadRequest)
...
func TestCDNOp_Delete_404(t *testing.T) {
	assert, api := setupCDN(t, nil, http.StatusNotFound)
...
func TestCDNOp_Status_200(t *testing.T) {
	assert, api := setupCDN(t, &MockDeploymentStatus)
...
func TestCDNOp_Status_400(t *testing.T) {
	assert, api := setupCDN(t, &MockErrorResponse, http.StatusBadRequest)
...
func TestCDNOp_Status_404(t *testing.T) {
	assert, api := setupCDN(t, nil, http.StatusNotFound)
...
func TestCDNOp_Integrated(t *testing.T) {

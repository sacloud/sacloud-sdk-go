...
type NICSettingHolder interface {
	GetConnectedSwitchParam() *iaas.ConnectedSwitch
...
func (c *SharedNICSetting) GetConnectedSwitchParam() *iaas.ConnectedSwitch {
	return &iaas.ConnectedSwitch{Scope: types.Scopes.Shared}
}
...
// GetConnectedSwitchParam サーバ作成時の接続先指定パラメータを作成して返す
func (c *ConnectedNICSetting) GetConnectedSwitchParam() *iaas.ConnectedSwitch {
	return &iaas.ConnectedSwitch{ID: c.SwitchID}
}
...
// GetConnectedSwitchParam サーバ作成時の接続先指定パラメータを作成して返す
func (d *DisconnectedNICSetting) GetConnectedSwitchParam() *iaas.ConnectedSwitch {
	return nil
}

...
func (s *Service) CreateWithContext(ctx context.Context, req *CreateRequest) (*iaas.CDROM, error) {
	...
	cdrom, ftpServer, err := client.Create(ctx, req.Zone, &iaas.CDROMCreateRequest{

	...
	cases := []struct {
		...
		},
		{
			in: &ApplyRequest{
				...
				EnableWebUI:             true,
				EnableBackupv2:          true,
				Backupv2Weekdays:        []types.EDayOfTheWeek{types.DaysOfTheWeek.Monday},
				Backupv2StartTimeHour:   10,
				Backupv2StartTimeMinute: 15,
				Backupv2Connect:         "nfs://192.0.2.11/export",
			},
			hasError: false,
		},
	}

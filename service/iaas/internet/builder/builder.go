...
func (b *Builder) Build(ctx context.Context, zone string) (*iaas.Internet, error) {
	...
	internet, err := b.Client.Internet.Create(ctx, zone, &iaas.InternetCreateRequest{
		Name:           b.Name,
...
func (b *Builder) Update(ctx context.Context, zone string, id types.ID) (*iaas.Internet, error) {
	...
	if internet.BandWidthMbps != b.BandWidthMbps {
		...
		// 成功するとIDが変更となる
		internet, err = b.Client.Internet.UpdateBandWidth(ctx, zone, internet.ID, &iaas.InternetUpdateBandWidthRequest{
			BandWidthMbps: b.BandWidthMbps,
		})
		if err != nil {
			return nil, err
	...
	internet, err = b.Client.Internet.Update(ctx, zone, internet.ID, &iaas.InternetUpdateRequest{
		Name:        b.Name,
		Description: b.Description,
		Tags:        b.Tags,
		IconID:      b.IconID,
